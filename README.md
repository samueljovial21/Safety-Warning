...
using several electronic components such as sensors and actuators. <br/> 
...
the mobile application interface. <br/> 
...
motorcycle's electrical path using a relay and detects indications of theft using sensors. <br/>
...
and actuator performance in following the specified logic commands. <br/> 
